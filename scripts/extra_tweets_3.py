...
EXTRA_TWEETS_3 = [
    ...
    "【WWW】WWWとは World Wide Web のことではない。World Wide Weight、即ち『全世界規模の重力（幸せ）』のことである。接続せよ、この巨大な愛に。🍖 #WWW #WorldWideWeight #DEVPARADE",

    "【LOVE】デブとは、この残酷な世界に対する『愛』のクッションだ。質量とは、誰かを抱きしめ、守り抜くための尊いリソースである。全てのステップ、全てのタグは、愛（Pure Love）から成る。🍖 #LOVE #DEVPARADE #ポジデブ哲学",
]
